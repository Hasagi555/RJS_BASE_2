...
class SearchOrder extends React.Component{
    render(){
        /* search order for website
        */
       return (
        <div className="container mt-4">
          <div className="row">
            <div className="col-12 title p-0">
              <h4><a href>Đơn hàng VPT_01_05_07_25896</a></h4>
            </div>
              ...
              <div className="row mt-3">
                ...
                <div className="col-12">
                  <div className="row">
                    ...
                    <div className="col-8">
                      <span className="font-weight-bold">Số 20, nguyễn trãi thanh xuân hà nội</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="row mt-3">
                  <div className="col-12">
                    <div className="row">
                      ...
                      <div className="col-8">
                        <span className="font-weight-bold">VPT_01_05_07_25896</span>
                      </div>
                    </div>
                  </div>
                  <div className="col-12">
                  ...
                  <div className="col-12">
                    <div className="row">
                      ...
                      <div className="col-8">
                        <span className style={{color: '#14ac79'}}>Đã thanh toán</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-12 mt-5 ">
              <div className="row mt-3">
                <span className="mb-3 font-weight-bold">Trạng thái vận chuyển</span>
