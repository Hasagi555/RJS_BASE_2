        ...
        <div className="container mt-3">
          <div className="row mb-5">
            <div className="col-12">
              <h4 className="mb-3"><a href>Đơn hàng vpt 01_03_02_25896</a></h4>
            </div>
                ...
                <form action="/action_page.php" className="pl-3 mt-3">
                  ...
                  <div className="form-check-inline">
                    <label className="form-check-label" htmlFor="check2">
                      <input type="checkbox" className="form-check-input" id="check2" name="vehicle2" defaultValue="something" />
                    </label>
            ...
            <div className="col-12 text-center mt-5">
              <button type="button" className="btn button">HOÀN THÀNH</button>
            </div>
          </div>
        </div>
      );
